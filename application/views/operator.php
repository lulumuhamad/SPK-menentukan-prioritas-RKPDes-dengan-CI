            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="active">
                        ...
                        <a href="<?php echo base_url() ?>User_control/operator"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a>                        
                    </li>
                    <li class="xn-active">
                        <a href="<?php echo base_url() ?>Usulan_control/""><span class="fa fa-files-o"></span> <span class="xn-text">Daftar Usulan</span></a>
                    </li>
                    <li class="xn-active">
                   ...
                   <!--  <li class="xn-openable">
                        ...
                        <ul>
                            ...
                            <li class="xn-openable">
                                ...
                                <ul>
                                    <li><a href="<?php echo base_url() ?>Usulan_control/hitung"><span class="fa fa-align-center"></span> Default</a></li>
